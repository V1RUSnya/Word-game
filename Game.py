...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayoutWidget_3.setGeometry(QtCore.QRect(0, 450, 411, 101))
        ...
        def SetAnswer():
            alfavit = ["й","ц","у","к","е","н","г","ш","щ","з","х","ъ","ф","ы","в","а","п","р","о","л","д","ж","э","я","ч","с","м","и","т","ь","б","ю"]
            result = 0
        ...
        self.SaveButton.clicked.connect(SetAnswer)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.LabelText.setText(_translate("MainWindow", "5 букв"))
        
    def buttonslogic(self):
        if self.lineSelector < 0:
            Flag = False
        else:
            Flag = True
        self.But1.setEnabled(Flag)
        self.But2.setEnabled(Flag)
        self.But3.setEnabled(Flag)
        self.But4.setEnabled(Flag)
        self.But5.setEnabled(Flag)
        self.But6.setEnabled(Flag)
        self.But7.setEnabled(Flag)
        self.But8.setEnabled(Flag)
        self.But9.setEnabled(Flag)
        self.But10.setEnabled(Flag)
        self.But11.setEnabled(Flag)
        self.But12.setEnabled(Flag)
        self.But13.setEnabled(Flag)
        self.But14.setEnabled(Flag)
        self.But15.setEnabled(Flag)
        self.But16.setEnabled(Flag)
        self.But17.setEnabled(Flag)
        self.But18.setEnabled(Flag)
        self.But19.setEnabled(Flag)
        self.But20.setEnabled(Flag)
        self.But21.setEnabled(Flag)
        self.But22.setEnabled(Flag)
        self.But23.setEnabled(Flag)
        self.But24.setEnabled(Flag)
        self.But25.setEnabled(Flag)
        self.But26.setEnabled(Flag)
        self.But27.setEnabled(Flag)
        self.But28.setEnabled(Flag)
        self.But29.setEnabled(Flag)
        self.But30.setEnabled(Flag)
        self.But31.setEnabled(Flag)
        self.But32.setEnabled(Flag)
